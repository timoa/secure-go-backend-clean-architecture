...
import (
	...
	mongo_drivermongo "go.mongodb.org/mongo-driver/v2/mongo"
...
func (_m *Collection) CountDocuments(_a0 context.Context, _a1 interface{}, _a2 ...options.Lister[options.CountOptions]) (int64, error) {
...
func (_m *Collection) Find(_a0 context.Context, _a1 interface{}, _a2 ...options.Lister[options.FindOptions]) (mongo.Cursor, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
...
func (_m *Collection) UpdateMany(_a0 context.Context, _a1 interface{}, _a2 interface{}, _a3 ...options.Lister[options.UpdateManyOptions]) (*mongo_drivermongo.UpdateResult, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, interface{}, ...options.Lister[options.UpdateManyOptions]) *mongo_drivermongo.UpdateResult); ok {
...
func (_m *Collection) UpdateOne(_a0 context.Context, _a1 interface{}, _a2 interface{}, _a3 ...options.Lister[options.UpdateOneOptions]) (*mongo_drivermongo.UpdateResult, error) {
	_va := make([]interface{}, len(_a3))
	for _i := range _a3 {
		_va[_i] = _a3[_i]
	}
	...
	var r0 *mongo_drivermongo.UpdateResult
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, interface{}, ...options.Lister[options.UpdateOneOptions]) *mongo_drivermongo.UpdateResult); ok {
		r0 = rf(_a0, _a1, _a2, _a3...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*mongo_drivermongo.UpdateResult)
